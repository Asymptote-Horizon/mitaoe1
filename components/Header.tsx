      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="flex items-center" style={{ color: effectiveScrolled ? '#141D49' : '#ffffff' }}> 
              {/* inline SVG uses currentColor so it can change on scroll */}
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 32" className="h-7 md:h-8 w-auto" aria-hidden>
